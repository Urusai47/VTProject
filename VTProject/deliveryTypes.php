...
if ($_POST['delete'] and $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (ctype_space($deliverytype) || $deliverytype == '' ) {
        $error = 'At least one of the field is empty';
    }  
    else {
        
        $sql = "CALL insert_deliverytype('" . $deliverytype . "', '" . $_SESSION["UserName"] . "')";
        $result = mysqli_query($db, $sql);       
    }
} 
else {}
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <!-- Logo -->
                        <div class="logo">
                            <h1><a href="deliveryTypes.php">Delivery Type</a></h1>
                        </div>
                    </div>             
                </div>
            </div>
                        ...
                        <div class="content-box-large">
                            <div class ="row ">
                                <form action="" method="post">  
                                    ...
                                    <div class="action">
                                        <input class="btn btn-primary signup" type = "submit" value = " Add Delivery Type "/><br />
                                    </div>    
                                </form>
                            </div>
                        </div>
